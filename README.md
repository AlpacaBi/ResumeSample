...
### 参与过的开源项目
 - [plyr.js](https://github.com/AlpacaBi/plyr)：一个国外的轻量级的开源视频组件，我为这个项目添加了视频markers功能和翻译了中文readme
 - [alpaca_blog](https://github.com/AlpacaBi/alpaca_blog)：一个基于typescript+golang+vue+graphql的个人博客系统
